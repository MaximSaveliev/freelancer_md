...
const MOCK_CHATS = [
  {
    ...
    messages: [
      ...
      { id: 2, sender: 'me', text: 'Здравствуйте, Александр! Спасибо.', time: '10:35' },
  ...
  },
  {
    ...
    unreadCount: 1,
    messages: [
      { id: 1, sender: 'me', text: 'Елена, подскажите, успеем ли мы закончить дизайн к пятнице?', time: 'Вчера 15:00' },
  ...
  },
  {
    ...
    messages: [
      ...
      { id: 2, sender: 'them', text: 'Получил, все отлично.', time: 'Пн 10:15' },
  ...
  },
  {
    ...
    unreadCount: 0,
    messages: [
      { id: 1, sender: 'them', text: 'Моя ставка 1500 руб/час.', time: '12 Мар 14:00' },
      { id: 2, sender: 'me', text: 'Хорошо, давайте начнем с 10 часов.', time: '12 Мар 14:10' },
      { id: 3, sender: 'them', text: 'Ок, договорились.', time: '12 Мар 14:15' },
    ]
  }
];
            ...
            filteredChats.map(chat => (
              ...
              >
                <div className="relative shrink-0">
                  ...
                  />
                  {chat.user.isOnline && (
                    <span className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-slate-card rounded-full"></span>
                  )}
                </div>
        ...
        {activeChat ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  {activeChat.user.isOnline && (
                    <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 border-2 border-slate-card rounded-full"></span>
                  )}
                </div>
                <div>
                  <h2 className="text-sm font-bold text-white">{activeChat.user.name}</h2>
                  <p className="text-xs text-slate-400">
                    {activeChat.user.isOnline ? 'В сети' : 'Был(а) недавно'}
                  </p>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-slate-500 p-8 text-center">
            ...
            <p className="text-sm max-w-md">
              Выберите чат из списка слева, чтобы начать общение, или найдите нужного пользователя через поиск.
            </p>
          </div>
        )}
      </div>
