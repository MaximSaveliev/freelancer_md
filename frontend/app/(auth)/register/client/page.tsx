                  ...
                  <div className="flex justify-between gap-2">
                    {otp.map((digit, index) => (
                      <input
                        ...
                        className="w-12 h-14 sm:w-14 sm:h-16 bg-slate-800/50 border border-slate-700 rounded-xl text-center text-2xl font-bold text-white focus:border-primary focus:shadow-[0_0_15px_rgba(242,125,38,0.15)] focus:outline-none transition-all"
                      />
                    ))}
                  </div>
